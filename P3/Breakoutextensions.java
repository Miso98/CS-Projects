 ...
 * to win the game. this is new in that the speed increases each time you hit a block
 */
...
public class Breakoutextensions extends GraphicsProgram {
	...
	/** this increments the speed and speeds up the ball every time you hit a block */
